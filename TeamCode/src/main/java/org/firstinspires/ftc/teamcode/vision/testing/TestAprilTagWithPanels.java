...
public class TestAprilTagWithPanels extends OpMode {
    ...
    public void loop(){
        ...
        if (botPoseMT1 != null){
            panelsTelemetry.addData("mt1 x", botPoseMT1.getX());
            panelsTelemetry.addData("mt1 y", botPoseMT1.getY());
            panelsTelemetry.addData("mt1 Heading", Math.toDegrees(botPoseMT1.getHeading()));
        }
        else {
            telemetry.addLine("mt1 is null");
            panelsTelemetry.addLine("mt1 is null");
        }
        ...
        if (botPoseMT2 != null){
            ...
            panelsTelemetry.addLine("mt2 is null");
        }

        if (botPoseMT2WithMT1 != null){
            panelsTelemetry.addData("mt2 with mt1 x", botPoseMT2WithMT1.getX());
            panelsTelemetry.addData("mt2 with mt1 y", botPoseMT2WithMT1.getY());
            panelsTelemetry.addData("mt2 with mt1 Heading", Math.toDegrees(botPoseMT2WithMT1.getHeading()));
        }
        else {
            telemetry.addLine("mt2 with mt1 is null");
            panelsTelemetry.addLine("mt2 with mt1 is null");
        }
